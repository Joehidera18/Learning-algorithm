...
Run once with --repo pointing to pinned V11.6, then with the revised source and
...
def main():
    ...
    if args.baseline:
        ...
        assert previous['result']['engine_version']=='market-structure-v11.6-candle-context'
